              ...
              <div class="card graf-11">
                <div class="card-body">
                  ...
                  <div style="color: blue; text-align: center">
                    <img src="../../image/reasignar.png" width="100px" height="100px" alt=""><br><br>
                    <button class='btn-1' hidden><a href="reasignar_ps.php" class="rutas">Productos y/o Servicios</a></button>
                    <button class='btn-1'><a href="M02SM02_Reasignar.php" class="rutas">Actividades Propias y/o Participantes</a></button><br><br>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="card graf-11">
                <div class="card-body">
                  ...
                  <div style="color: blue; text-align: center">
                    ...
                    <img src="../../image/cumplimiento.png" width="100px" height="100px" alt=""><br><br>
                    <button class='btn-1' hidden><a href="cumplimiento_ps.php" class="rutas">Productos y/o Servicios</a></button>
                    <button class='btn-1'><a href="M02SM04_Cumplimiento.php" class="rutas">Actividades Propias y/o Participantes</a></button><br><br>
                  </div>
                </div>
              </div>
            </div>
...
<script src="../../js/M02_Supervisar/M02JS01_Supervisar/M02JS01_Supervisar.js?v=1.1.1"></script>
