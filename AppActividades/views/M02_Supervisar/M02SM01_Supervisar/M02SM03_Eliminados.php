...
<body>
        ...
        <div class="page-wrapper">
            ...
            <div class="breadcrumb-ancho">
                <ol class="breadcrumb breadcrumb-arrow">
                    ...
                    <li><a class="enlace" href="javascript:void(0)">Actividades Eliminadas</a></li>
                </ol>
            </div>
            <!-- ============================================================== -->
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Actividades Registradas</h4>
                ...
                <div class="modal fade" id="modalRestablecer" tabindex="-1" role="dialog" data-backdrop="static"
                aria-labelledby="myModalLabel">
                    <?php
                    require_once "pop-up/M02SM02_POPUP_Restablecer.php";
                    ?>
                </div>
                <!-- ============================================================== -->
                <!-- End PAge Content -->
    ...
    <script src="../../js/M02_Supervisar/M02JS01_Supervisar/M02JS03_Eliminados.js?v=1.1.1"></script>
