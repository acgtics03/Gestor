...
<body>
    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="modal fade" id="modalReasignar" tabindex="-1" role="dialog" data-backdrop="static"
                aria-labelledby="myModalLabel">
                    <?php
                    require_once "pop-up/M02SM01_POPUP_Reasignar.php";
                    ?>
                </div>
                <!-- ============================================================== -->
                <!-- End PAge Content -->
    ...
    <script src="../../js/M02_Supervisar/M02JS01_Supervisar/M02JS02_Reasignar.js?v=1.1.1"></script>
