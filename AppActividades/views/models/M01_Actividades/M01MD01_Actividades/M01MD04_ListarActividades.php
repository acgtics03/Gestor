...
if(isset($_POST['ReturnListaActividades'])){
    ...
    if(!empty($bxfiltroIdentificadorr)){
        ...
        if($bxfiltroIdentificadorr=='1'){
            ...
            if($tipo=="SUPERVISOR"){
                if($ids=="38"){
                    if(empty($bxfiltroResponsabler) || $bxfiltroResponsabler=="todos"){ $responsable=""; }else{ $responsable="AND a.responsable='".$bxfiltroResponsabler."'";}
                }else{
                    if(empty($bxfiltroResponsabler) || $bxfiltroResponsabler=="todos"){ $responsable="AND p.idArea='$area'"; }else{ $responsable="AND a.responsable='".$bxfiltroResponsabler."' AND p.idArea='$area'";}
                }
            }else{
          ...
          if(empty($query_fecha2)){$query_fecha2="AND a.fecha BETWEEN '$primer_dia' AND '$fecha_hoy'"; }
            ...
            $querys = "SELECT 
             ...
             if($tipo=="SUPERVISOR"){
                  if($ids=="38"){
                      ...
                      if(empty($bxfiltroResponsabler) || $bxfiltroResponsabler=="todos"){ 
                            $responsable="AND p.idArea='$area'"; 
                            $responsable2=""; 
                        }else{ 
                            $responsable="AND a.responsable!='".$bxfiltroResponsabler."' AND p.idArea='$area'"; 
                            $responsable2="AND tr.responsable='".$bxfiltroResponsabler."'"; 
                        }
                  }
            }else{
       ...
       if(empty($query_fecha)){$query_fecha="AND a.fecha BETWEEN '$primer_dia' AND '$fecha_hoy'"; }
