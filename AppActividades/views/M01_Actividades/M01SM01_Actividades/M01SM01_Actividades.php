        ...
        <div class="page-wrapper">
            ...
            <div class="breadcrumb-ancho">
                <ol class="breadcrumb breadcrumb-arrow">
                    ...
                    <li><a class="enlace" href="javascript:void(0)">Gestión de Actividades</a></li>
                </ol>
            </div>
            <!-- ============================================================== -->
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="card tam-pnl">
                            <form class="form-horizontal">
                                <div class="card-body">
                                    <div class="col">
                                        <h4 class="card-title subtit-panel">Actividades <span class="estatus-1">Planificadas</span> y <span class="estatus-2">en Proceso</span> (<?php echo $fecha_hoy; ?>)</h4>
                                        <hr>
                                    </div>
                                    <div class="col-md-12">
                    ...
                    <div class="col-md-6">
                        <div class="card tam-pnl">
                            <div class="card-body">
                                <div class="col">
                                    <h4 class="card-title subtit-panel">Registrar Actividad</h4>
                                    <hr>
                                </div>

                                <div class="form-group row col">
                                    <label for="fname" class="col-sm-3 text-right control-label col-form-label label-texto-sm">Nombre(*)</label>
                                    <div class="col-sm-9">
                                        <select class="cbx-texto" name="bxTipoActividad" id="bxTipoActividad">
                                ...
                                <div class="form-group row col">
                                    <label for="lname" class="col-sm-3 text-right control-label col-form-label label-texto-sm">Descripción(*)</label>
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group row col">
                                    <label for="fname" class="col-sm-3 text-right control-label col-form-label label-texto-sm">Responsable(*)</label>
                                    <div class="col-sm-9">
                                        <select class="cbx-texto" name="bxResponsable" id="bxResponsable">
                                            <option selected="true" disabled="disabled">Seleccionar..</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <div class="row col">
                                        <label for="fname" class="col-sm-4 text-right control-label col-form-label label-texto-sm">Cliente(*)</label>
                                        <div class="col-sm-7">
                                            <select class="cbx-texto" name="bxCliente" id="bxCliente">
                                                <option selected="true" disabled="disabled">Seleccionar..</option>
                                                <?php
                                    ...
                                    <div class="row col">
                                        <label for="fname" class="col-sm-4 text-right control-label col-form-label label-texto-sm">Tipo(*)</label>
                                        <div class="col-sm-7">
                                            <select class="cbx-texto" name="bxTipo" id="bxTipo">
                                                <option selected="true" disabled="disabled">Seleccionar..</option>
                                                <?php
                                ...
                                <div class="form-group row">
                                    <div class="row col">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="date" class="caja-texto" name="txtFechaInicio" id="txtFechaInicio">
                                        </div>
                                    </div>

                                    <div class="row col">
                                        <label for="fname" class="col-sm-4 text-right control-label col-form-label label-texto-sm">Termino(*)</label>
                                        <div class="col-sm-7">
                                             <input type="date" class="caja-texto" name="txtFechaTermino" id="txtFechaTermino">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <div class="row col">
                                        <label for="fname" class="col-sm-4 text-right control-label col-form-label label-texto-sm ">Hr Inicio(*)</label>
                                        <div class="col-sm-7">
                                            <div class="row">
                                                <div class="col">
                                                    <input type="number" class="caja-texto" name="txtHoraInicio" id="txtHoraInicio" list="horas" placeholder="Hrs" onKeyDown="limitText(this,2);" onKeyUp="limitText(this,2);">
                                                    <datalist id="horas">
                                                        <?php
                                    ...
                                    <div class="row col">
                                        <label for="fname" class="col-sm-4 text-right control-label col-form-label label-texto-sm">Hr Inicio Real</label>
                                        <div class="col-sm-7">
                                            <div class="row">
                                                <div class="col">
                                                    <input type="number" class="caja-texto" name="txtHoraInicioReal" id="txtHoraInicioReal" list="horas" placeholder="Hrs" onKeyDown="limitText(this,2);" onKeyUp="limitText(this,2);">
                                                    <datalist id="horas">
                                                        <?php
                                                        $Horas = new ControllerCategorias();
                                                        $verHoras = $Horas->VerHoras();
                                ...
                                <div class="form-group row">
                                    <div class="row col">
                                        <label for="fname" class="col-sm-4 text-right control-label col-form-label label-texto-sm ">Hr Termino(*)</label>
                                        <div class="col-sm-7">
                                            <div class="row">
                                                <div class="col">
                                                    <input type="number" class="caja-texto" name="txtHoraFin" id="txtHoraFin" list="horas" placeholder="Hrs" onKeyDown="limitText(this,2);" onKeyUp="limitText(this,2);">
                                                    <datalist id="horas">
                                                        <?php
                                                        $Horas = new ControllerCategorias();
                                                        $verHoras = $Horas->VerHoras();
                                    ...
                                    <div class="row col">
                                        <label for="fname" class="col-sm-4 text-right control-label col-form-label label-texto-sm">Hr Termino Real</label>
                                        <div class="col-sm-7">
                                            <div class="row">
                                                <div class="col">
                                                    <input type="number" class="caja-texto" name="txtHoraFinReal" id="txtHoraFinReal" list="horas" placeholder="Hrs" onKeyDown="limitText(this,2);" onKeyUp="limitText(this,2);">
                                                    <datalist id="horas">
                                                        <?php
                                                        $Horas = new ControllerCategorias();
                                                        $verHoras = $Horas->VerHoras();
                            ...
                            <div class="border-top">
                                <div class="card-body" style="margin-top: -2%;">
                                    <button id="guardar" type="button" class="btn btn-registro"><i class="fas fa-save"></i> Guardar</button>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="modal fade" id="modalParticipantes" tabindex="-1" role="dialog" data-backdrop="static"
                aria-labelledby="myModalLabel">
                    <?php
                    require_once "pop-up/M01SM01_POPUP_Participantes.php";
                    ?>
                </div>

                <div class="modal fade" id="modalTareas" tabindex="-1" role="dialog" data-backdrop="static"
                ...
                aria-labelledby="myModalLabel">
                    <?php
                    require_once "pop-up/M01SM01_POPUP_EliminarActividad.php";
                    ?>
                </div>

                <div class="modal fade" id="modalComentariosActividad" tabindex="-1" role="dialog" data-backdrop="static"
                aria-labelledby="myModalLabel" style="margin-left: -400px;">
                    <?php
                   require_once "pop-up/M01SM01_POPUP_ComentariosActividades.php";
                    ?>
                </div>

                <div class="modal fade" id="modalEditarTareas" tabindex="-1" role="dialog" data-backdrop="static"
                aria-labelledby="myModalLabel">
                    <?php
