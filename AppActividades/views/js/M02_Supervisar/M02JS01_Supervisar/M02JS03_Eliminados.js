...
function Control() {
  ...
  $('#btnCerrarSesion').click(function() {
    ...
    $('#bxAreaParticipantes').change(function() {
      ...
      $('#btnRestablecerActividad').click(function() {
        Restablecer();
     });
    ...
    getTablaBusquedaCabGenerado = $('#TablaActividades').DataTable({
        ...
        columns: [{
                ...
                "render": function(data, type, row) {
                    return '<button class="btn btn-edit-action"   onclick="AbrirModalRestablecer(\'' + data + '\')"><i class="fas fa-sync-alt"></i></button>';
                }
            },
            { "data": "fecha" },
            { "data": "fechafin" },
...
function Restablecer() {
   ...
   bloquearPantalla("Buscando...");
    var data = {
        "btnRestablecerActividad": true,
        "IdRegistro": $("#txtidactividadd").val(),
        "bxEstadoAct": $("#bxEstadoAct").val()
    };
    $.ajax({
        type: "POST",
        url: "../../models/M02_Supervisar/M02MD01_Supervisar/M02MD01_Procesos.php",
