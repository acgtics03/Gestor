          ...
          <div class="col-lg-6">
            <div class="card graf-11">
              <div class="card-body" style="height: 475px">
                <div><a href="cumplimiento_apap.php" style="color: blue;">
                    <-- Ir a Actividades</a> </div> <br>
                      ...
                      <div class="table-responsive tabla-r">
                        <table class="table table-striped table-bordered">
                          ...
                          ?>
                            ...
                            <body>
                              <tr>
                                <td style="color: black; font-size: 12px;"><?php echo $verPart['datos']; ?></td>
                                <td style="color: black; font-size: 12px;"><?php echo $verPart['area']; ?></td>
                      ...
                      <div class="col-lg-12">
                        <div class="table-responsive">
                          ...
                          <table id="example" class="table table-striped table-bordered" cellspacing="0" style="font-size: 14px;">
                            ...
                            <tbody>
                              <?php
                              require('../models/segtareassuper.php');
                              ?>
                            </tbody>
                          </table>
                        </div>
