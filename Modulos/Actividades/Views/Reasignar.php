    ...
    <div class="content-wrapper fondo">
      <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-12 col-lg-12">
              <div class="card reg-tab2">
                <div class="card-header titulos_super">REASIGNAR ACTIVIDADES PROPIAS</div>
                          ...
                          <table id="example" class="table table-striped table-bordered" cellspacing="0" style="font-size: 14px;">
                            ...
                            <tbody>
                              <?php
                                    ...
                                    AND p.idJefeInmediato='$username' AND a.identificador='DIARIO' AND (a.estado!='FINALIZADO' AND a.estado!='ELIMINADO')");
