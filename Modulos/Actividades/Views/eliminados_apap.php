...
<head><meta charset="big5">
  ...
  <link rel="stylesheet" href="css/estilo.css?v=<?php echo time(); ?>" />
    ...
    <script src="../Js/popup_rae.js"></script>
          ...
          <div class="row">
            <div class="col-12 col-lg-12">
              <div class="card reg-tab2">
                ...
                <div class="card-header">ACTIVIDADES PROPIAS ELIMINADOS
                  <div class="container">
                    <div class="row">
                      <div class="col-lg-12">
                          ...
                          <table id="example" class="table table-striped table-bordered" cellspacing="0" style="font-size: 14px;">
                            ...
                            <tbody>
                              <?php
                                    ...
                                    WHERE p.idusuario=u.usuario AND a.responsable=u.idusuario AND me.idmeps=a.MotivoEliminado AND t.idgestion=a.nombre AND p.idJefeInmediato='$username' AND a.estado='ELIMINADO'");
