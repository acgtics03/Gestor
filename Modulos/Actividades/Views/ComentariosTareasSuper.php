...
<body class="bg-theme fondo">
    ...
    require "pasando_variable_tarea.php";
                ...
                <div class="row mt-3">
                    <div class="col-lg-6">
                        <div class="card graf-11" style="height: 745px;"><br>
                            <div class="card-header"><a href="SegActividadesSuperv.php" style="color: rgb(22, 55, 91)"><img src="image/espalda.png" width="30px" height="30px"> Volver atrás</a></div>
                            <div class="card-body">
                                <h5 class="card-header h-div">Detalle de la Tarea</h5>
                                <br>
                                <div class="table-responsive tabla-t">
                                    ...
                                    <br><br><br><br>
                                    <form action="../models/insertar_comentariotarea.php" method="post">
                                    ...
                                    <div class="form-group">
                                        <div class="content-tab">
                                            <table class="table-coment" style="width: 100%;">
                                                ...
                                                <tbody>
                                                    <?php
                                                    $consultar_comentarios = mysqli_query($conection, "SELECT ca.idtarea as idc, ca.comentario as coment, date_format(ca.hora, '%H:%i') as hora, ca.fecha as fec, concat(SUBSTRING_INDEX(p.apellido,' ',1),' ',SUBSTRING_INDEX(p.nombre,' ',1)) as datos, cc.r as R, cc.g as G, cc.b as B FROM coment_tareas ca, usuario u, persona p, color_coment cc WHERE cc.idcolor=ca.idcolor AND ca.idusuario=u.idusuario AND u.usuario=p.idusuario AND ca.idtarea='$idactiv' ORDER BY ca.fecha, ca.hora ASC");
